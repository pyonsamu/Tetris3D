...
internal class ZMino : TetriMino
{
    ...
    public ZMino(Position2D pos) : base(pos)
    {
    }

    public ZMino(Position2D pos, Direction rotation) : base(pos, rotation)
    {
    }

    public override void setObject()
    {
        GameObject obj = (GameObject)Resources.Load("Tetris\\ZMino1");
    ...
    {
        return new ZMino(MainPos.clone(), Rotation);
    }
}