...
internal class JMino : TetriMino
{
    ...
    public JMino(Position2D pos) : base(pos)
    {
    }

    public JMino(Position2D pos, Direction rotation) : base(pos, rotation)
    {
    }

    public override void setObject()
    {
        GameObject obj = (GameObject)Resources.Load("Tetris\\JMino1");
    ...
    {
        return new JMino(MainPos.clone(), Rotation);
    }
}